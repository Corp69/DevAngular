...
export class ImpuestosFederalesService {
    ...
    return this.http.post(`${environment.baseUrl}clientes/ctr/schema`,
      {
        ...
        "funcion": "app_producto_servicios_impuestos_federales",
        "data": {
          "_id_inv_producto": id
        }
      },
  ...
  public EliminarIds(
    ...
    return this.http.post(`${environment.baseUrl}clientes/ctr/eliminarIds`,
      {
        "Qtabla": _tabla,
        "Id_principal": _Id_principal,
        "Id_principal_valor": _Id_principal_valor,
