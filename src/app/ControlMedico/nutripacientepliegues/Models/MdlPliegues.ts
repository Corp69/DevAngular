export class MdlPliegues
{
	...
	public p_cresta_ileaca: number = 0.00;
	public p_supraespinal: number = 0.00;
	public p_abdominal: number = 0.00;
	public p_muslo: number = 0.00;
	public p_pantorrilla: number = 0.00;
